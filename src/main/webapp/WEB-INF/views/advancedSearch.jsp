...
<%
List<StatementGovernmentSchemes> statementGovernmentSchemeSuperList = null;

	
	if(request.getAttribute("statementGovernmentSchemeSuperList") != null &&
	   !request.getAttribute("statementGovernmentSchemeSuperList").equals("")){
		statementGovernmentSchemeSuperList = (List<StatementGovernmentSchemes>)request.getAttribute("statementGovernmentSchemeSuperList");
	}
...
%>
			...
			<!-- !Messages and Help -->
				  ...
				  <section id="main-content">
					...
					<!-- !Main Content -->
						 ...
						 <span>
						 <form action = "<%=request.getContextPath() %>/schemes/search/" method = "post">
      ...
      <option value = "pradhan-mantri-yojana-govt-schemes">Pradhan Mantri Yojana Government Schemes</option>
						 ...
						 <ul>
						 <%
						 if(statementGovernmentSchemeSuperList != null){
							 for(StatementGovernmentSchemes schemeCat : statementGovernmentSchemeSuperList){
...
document.getElementById("searchCount").innerHTML = "Search Results - " + "<%=seaI %> : " + ";  
