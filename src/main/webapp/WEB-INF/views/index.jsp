...
<a href="javascript:void(0)" id="advsearchbtn">Advanced Search</a>
						...
						<div id="light" class="white_box" style="width: 380px; top: 40px;">	
							<div class="search-form">
								<form action="" method="get" id="views-exposed-form-advance-metadata-search-page-1" accept-charset="UTF-8"><div><div class="views-exposed-form">
 ...
 <select id="edit-sort-order" name="sort_order" class="form-select"><option value="ASC">Asc</option><option value="DESC" selected="selected">Desc</option></select>
  ...
  <div class="block-content content"><div class="view view-most-search view-id-most_search view-display-id-block view-dom-id-e38b830996d06758e7d3042e35592d38">
	...
	<form action="<%=request.getContextPath() %>/schemes/searchByVariousFilters" method="get" id="views-exposed-form-advance-metadata-search-page-1" accept-charset="UTF-8">
	<div>
	<div class="views-exposed-form" style = "margin-left:350px;">
  <div class="views-exposed-widgets clearfix">
          <div id="edit-term-node-tid-depth-wrapper" class="views-exposed-widget views-widget-filter-term_node_tid_depth">
                  <label for="edit-term-node-tid-depth">
            Designation          </label>
                        <div class="views-widget">
          <div class="form-item form-type-select form-item-term-node-tid-depth">
 <select id="edit-term-node-tid-depth" name="designation" class="form-select">
 ...
 <option value="doctor">Doctor</option>
          ...
          <div id="edit-term-node-tid-depth-wrapper" class="views-exposed-widget views-widget-filter-term_node_tid_depth">
            ...
            Category          </label>
                        <div class="views-widget">
          <div class="form-item form-type-select form-item-term-node-tid-depth">
 <select id="edit-term-node-tid-depth" name="category" class="form-select">
 ...
 <option value="ecucation">Education</option>
 ...
 <option value="electricity">Electricity</option>
            ...
            Salary          </label>
                        <div class="views-widget">
          <div class="form-item form-type-select form-item-term-node-tid-depth">
 <select id="edit-term-node-tid-depth" name="salary" class="form-select">
 ...
 <option value="More than 5,00,000">More than 5,00,000</option>
      ...
      <div id="edit-term-node-tid-depth-wrapper" class="views-exposed-widget views-widget-filter-term_node_tid_depth">
            ...
            Age          </label>
                        <div class="views-widget">
          <div class="form-item form-type-select form-item-term-node-tid-depth">
 <select id="edit-term-node-tid-depth" name="age" class="form-select">
 <option value="Less than 5 years">Less than 5 years</option>
 <option value="Between 5 and 10 years">Between 5 and 10 years</option>
 <option value="Between 10 and 18 years">Between 10 and 18 years</option>
 <option value="Between 18 and 23 years">Between 18 and 23 years</option>
 <option value="Between 23 and 36 years">Between 23 and 36 years</option>
 <option value="Between 36 and 60 years">Between 36 and 60 years</option>
 <option value="More than 60 years">More than 60 years</option>
 </select>
</div>
        </div>
              </div>
                <div class="views-exposed-widget views-submit-button" style = "margin-top:-0.8em;">
      <input type="submit" id="edit-submit-advance-metadata-search" value="Search" class="form-submit" />    </div>
      </div>
</div>
</div></form>
